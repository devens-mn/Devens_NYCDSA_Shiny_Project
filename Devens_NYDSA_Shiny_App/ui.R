        ...
        tabItems(
            tabItem(tabName = "Introduction",
                ...
                ,p('Internet marketplaces offer marketers the ability to track on an individual
                    ...
                    for an unnamed "leisure and fun" activity pricing experiment run online by 
                    a company during Q2 2017 and presented at https://www.kaggle.com/shariqhhashmi/pricing-point#promo_results.csv' )
                ,h4('Objective')
                ,p("Our goal is to recommend methods to this company's management and marketing in order to maximize the
                   ...
                   and other factors on purchasing decisions observed during this experiment.")
                ,h4('Description of experiment')
                ,p('The experiment changed the activity price from $199 to
                    $299 a third of the time, such that the ratios were approximately evenly distributed 
            ...
            ,tabItem(tabName = "EconomicAnalysis",
                ...
                ,p('Economic models also predict the revenue will increase with
                   ...
                   curve, though in the price-inelastic region at high prices revenue decreases as demand
                   drops more quickly with increasing price. The figure below demonstrates
                ...
                ,p('Further experiments are required to determine if $299 is still in the price-elastic region
                   of the demand curve, due to the non-linear nature of this quantity. If $299
            ...
            ,tabItem(tabName = "BuyingFactors",
                 ...
                 ,p('We first examine the total number of site visits by day of week, 
                 ...
                 the decrease in activity bookings did not change uniformly.  In the figure below
                    ...
                    the decision to purchase. We find that Google Adwords (now Google Ads), Facebook and Unknown all
                    ...
                    have a relatively larger number of referrals.  Similarly mobile users
                    had a relatively higher volume and a higher booking percentage at $299 which
            ...
            ,tabItem(tabName = "BuyingAnalysis",
                     ...
                     ,p('Similarly, we examined the significance of device with 1 as desktop. While device is
                        significant at 95%, it only barely achieves this level for a $299 price and is
                        of marginal importance.')
                     ,verbatimTextOutput('prptest2')
                     ,p('Finally, we attempted to use logistic regression model to determine 
                        if there is an interaction between price and source.  However, the design
                        of the experiment did not account for interactions and they are confounded
                        ...
                        The decrease was 13% lower from basis for an increase of $100.  However, a caveat
                        ...
                        (not shown but implied) as the highest likelihood of booking a trip,
                        followed by Bing (though the traffic is small.)  The likelihood of purchase
                        for a Bing referral is 22% lower from basis at the #299 price. Finally,
            ...
            ,tabItem(tabName = "Recommendations",
                     ...
                     ,h4('Recommendations')
                        ...
                        quantity sold.  Further experimentation
                        could indicate if there is further price elasticity and
                        the potential for a higher price and revenue.')
                     ,p('We also recommend these actions with respect to marketing
                        and advertising')
                     ,tags$ul(
